...
const certifications = [
  {
    ...
    description: 'Completed the NPTEL Programming in Java course with 84% and received an Elite certificate from IIT Kharagpur.',
  ...
  {
    title: 'Learn Web Development with HTML, CSS, JavaScript',
    issuer: 'Coursera',
    date: 'Apr 2024',
    platform: 'Coursera',
    credentialId: 'W5XYDE5VODKRX',
    skills: ['HTML5', 'CSS3', 'JavaScript', 'Web Development', 'Responsive Design'],
    description: 'Completed a web development course covering modern HTML5, CSS3, and JavaScript fundamentals.',
