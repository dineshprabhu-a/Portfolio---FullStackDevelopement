...
const experiences = [
  {
    ...
    points: [
      'Modernized a legacy Perl rules application by migrating 15,000+ business rules to Java using Core Java Collections and Stream API for better performance and maintainability.',
      'Designed and developed a Java-based DSL engine supporting 20+ operators with registry-driven syntax and semantic validation.',
      'Built REST APIs for DSL rule authoring, task lifecycle management, version history, and dark-launch deployment with rollback support.',
      'Designed multi-scope database schemas (global/local/network) and integrated observability using Grafana dashboards for rule execution metrics.',
      'Achieved 95%+ unit test coverage and managed Bitbucket pull requests for conflict-free team integration.',
    ],
    skills: ['Java', 'Spring Boot', 'DSL Design', 'Stream API', 'Grafana', 'Unit Testing'],
  },
  {
